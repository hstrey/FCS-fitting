...
data3dGaussian=pd.read_csv(datadir+'gaussian.csv')
data3dGaussianTriplet=pd.read_csv(datadir+'gaussian_triplet.csv')
dataNumerical=pd.read_csv(datadir+'Numerical.csv')
dataNumericalTriplet=pd.read_csv(datadir+'NumericalTriplet.csv')
