...
from fcsfit.realistic_reversed import modelFCS_nr, modelFCS_ntr, modelFCS_n
...
for color in parameters:
    ...
    for i in range(len(experiments)):
        ...
        datasetG = makeResultDataFrame(resultG,
                                       {'fit': 'fcs', 'file': filename, 'color': color, 'chisq': resultG.chisqr,
                                        'redchi': resultG.redchi})
        ...
        datasetS = makeResultDataFrame(resultS,
                                       {'fit': 'fcs_t', 'file': filename, 'color': color, 'chisq': resultS.chisqr,
        ...
        datasetN = makeResultDataFrame(resultN,
                                       {'fit': 'fcs_n', 'file': filename, 'color': color, 'chisq': resultN.chisqr,
                                        'redchi': resultN.redchi})
        ...
        logfile.write(resultN.fit_report() + '\n')
        datasetN = makeResultDataFrame(resultN,
                                       {'fit': 'fcs_nt', 'file': filename, 'color': color, 'chisq': resultN.chisqr,
                                        'redchi': resultN.redchi})
        parameterDataFrame = parameterDataFrame.append(datasetN, ignore_index=True)
        ...
        logfile.write(resultN.fit_report() + '\n')
        datasetN = makeResultDataFrame(resultN,
                                       {'fit': 'fcs_nr', 'file': filename, 'color': color, 'chisq': resultN.chisqr,
                                        'redchi': resultN.redchi})
        parameterDataFrame = parameterDataFrame.append(datasetN, ignore_index=True)
        ...
        logfile.write(resultN.fit_report() + '\n')
        datasetN = makeResultDataFrame(resultN,
                                       {'fit': 'fcs_ntr', 'file': filename, 'color': color, 'chisq': resultN.chisqr,
                                        'redchi': resultN.redchi})
        parameterDataFrame = parameterDataFrame.append(datasetN, ignore_index=True)
